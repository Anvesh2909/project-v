        ...
        <div className="p-4 md:p-6 bg-gray-50">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-blue-800">My Profile</h1>
                        <p className="text-gray-500 mt-1">Club Points:
                            <span className="font-medium text-blue-700 ml-1">{data?.silPoints || 0}</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className="space-y-4 md:space-y-6">
                        {/* Profile Card */}
                        <div className="bg-white rounded-xl p-5 md:p-6 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                            <div className="flex flex-col items-center">
                                <div className="w-24 h-24 rounded-full overflow-hidden mb-4 border-2 border-blue-200 shadow-md">
                                    <Image
                                ...
                                <div className="w-full mt-4 space-y-3">
                                    ...
                                    <div className="flex items-center bg-blue-50 rounded-lg p-3 hover:bg-blue-100 transition-all duration-300">
                                        <Book className="w-5 h-5 mr-3 text-blue-500 flex-shrink-0" />
                                ...
                                <Link
                                    ...
                                    className="mt-5 py-2.5 px-5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg font-medium transition-all hover:shadow-md hover:from-blue-700 hover:to-blue-600 w-full text-center"
                                >
                                    Update Profile
                                </Link>
                            </div>
                        ...
                        <div className="bg-white rounded-xl p-5 md:p-6 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between text-sm">
                                    <span className="text-blue-800 font-medium">{data?.silPoints || 0} Points</span>
                        ...
                        <div className="bg-white rounded-xl p-5 md:p-6 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="text-center py-6 px-2">
                                ...
                                <Link
                                    ...
                                    className="text-blue-600 hover:text-blue-700 font-medium flex items-center justify-center group"
                                >
                        ...
                        {/* Feedback & Support Card - Enhanced */}
                        <div className="bg-white rounded-xl p-5 md:p-6 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                            <div className="flex items-center mb-4">
                                <MessageSquare className="w-5 h-5 mr-2 text-blue-500" />
                                <h3 className="text-lg font-semibold text-blue-800">Feedback & Support</h3>
                            </div>
                            <div className="space-y-4">
                                <div className="flex items-start p-3 bg-blue-50 rounded-lg">
                                    <ThumbsUp className="w-5 h-5 mr-3 text-blue-500 flex-shrink-0 mt-0.5" />
                                    <div>
                                        <h4 className="font-medium text-blue-700 mb-1">Share Your Experience</h4>
                                ...
                                <Link
                                    ...
                                    className="mt-2 py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all flex items-center justify-center"
                                >
                    ...
                    <div className="lg:col-span-2 space-y-4 md:space-y-6">
                                ...
                                <div className="space-y-3">
                                    {currentCourses.map((course, index) => (
                                        <Link key={index} href={`/dashboard/courses/${course.id}`}>
                                            <div className="bg-blue-50 rounded-lg p-4 group hover:bg-blue-100 transition-all duration-300 border border-transparent hover:border-blue-200">
                                                <div className="flex justify-between items-center">
                                                    <h3 className="text-blue-800 font-medium group-hover:text-blue-900">{course.name}</h3>
                                                    <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium group-hover:bg-blue-200">
                                                        {course.deadline}
                                                    </span>
                                                </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div className="bg-white rounded-xl p-4 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                                <div className="flex items-center mb-2">
                                    <LineChart className="w-5 h-5 mr-2 text-blue-500" />
                                    <span className="text-gray-500">Rating</span>
                                </div>
                                <div className="text-2xl md:text-3xl font-bold text-blue-800">{data?.cgpa || "N/A"}</div>
                            ...
                            <div className="bg-white rounded-xl p-4 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                                ...
                                <div className="text-2xl md:text-3xl font-bold text-blue-800">{data?.silPoints || 0}</div>
                            ...
                            <div className="bg-white rounded-xl p-4 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                                ...
                                <div className="text-2xl md:text-3xl font-bold text-blue-800">{currentCourses.length}</div>
                        ...
                        <div className="bg-white rounded-xl p-5 md:p-6 shadow-md border border-blue-100 hover:shadow-lg transition-shadow duration-300">
                            ...
                            <div className="text-center py-8 bg-blue-50 rounded-lg">
                                <Medal className="w-12 h-12 text-blue-300 mx-auto mb-3" />
                                <p className="text-gray-600 mb-1">Earn badges by participating in club activities and events.</p>
                                <p className="text-blue-600 font-medium mt-2">Coming Soon!</p>
                            </div>
                        </div>
                    </div>
                </div>
