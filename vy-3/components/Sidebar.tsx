...
export default function Sidebar() {
    ...
    const navItems = [
        ...
        { name: "Clubs", Icon: Globe, href: "/dashboard/clubs"}
    ];

    return (
        <aside
            className={`fixed left-4 top-4 bottom-4 ${isCollapsed ? 'w-20' : 'w-64'} 
                bg-gray-800 text-white border border-blue-700/30
            ...
            <div className="mt-auto pt-6 border-t border-blue-700/50">
                <Link
                    ...
                    className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} p-2 rounded-lg 
                        hover:bg-blue-700 transition-all duration-200 mb-4 group`}
                ...
                >
                    <div className="relative">
                        ...
                        />
                        <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 rounded-full border-2 border-blue-800"></span>
                    </div>
                    {!isCollapsed && (
